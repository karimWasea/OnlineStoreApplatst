...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 399957c0-2b37-4464-ac34-cde7cc4ee1d0
```

> `399957c0-2b37-4464-ac34-cde7cc4ee1d0` is the password of the certificate, you can change it to any password you want.
...
Run `OnlineStore.DbMigrator` to create the initial database. This should be done in the first run. It is also needed if a new database migration is added to the solution later.
